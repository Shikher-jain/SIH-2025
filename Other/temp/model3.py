...
def load_and_reshape_seq(ndvi_folder, sensor_folder, yield_csv_path, target_height=300, target_width=300):
...
def main(ndvi_folder, sensor_folder, yield_csv_path):
    # Target spatial size (adjust as per your model / data)
    target_height = 316
    target_width = 316
...
if __name__ == "__main__":
    ...
    # time_steps = 2  # Set based on your data organization
    # main(ndvi_folder, sensor_folder, yield_csv, time_steps)
